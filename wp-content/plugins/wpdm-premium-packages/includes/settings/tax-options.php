...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div style="clear: both;margin-top:20px ;"></div>
        <input type="checkbox" value="1" <?php if (isset($settings['tax']['enable']) && $settings['tax']['enable'] == 1) echo "checked='checked'"; ?> id="tax_calculation" name="_wpdmpp_settings[tax][enable]"> <?php echo __("Enable tax calculation", "wpdm-premium-package"); ?><br/>
                ...
                <tr id="r_<?php echo $key; ?>">
                    ...
                    <td id="cahngestates_<?php echo $key; ?>">
                        ...
                        <select class="taxstate" name="_wpdmpp_settings[tax][tax_rate][<?php echo $key; ?>][state]" <?php echo $has_states ? '' : 'disabled="disabled" style="display:none"'; ?> >
                            <option <?php if ($settings['tax']['tax_rate'][$key]['state'] == 'ALL-STATES') echo 'selected=selected' ?> value="ALL-STATES"><?php _e('All States','wpdm-premium-package'); ?></option>
                    ...
                    <td><a href="#" class="del_rate" rel="<?php echo $key; ?>"><?php _e('Delete','wpdm-premium-package'); ?></a></td>
                </tr>
                <?php
            }
        }
        ...
        <div style="clear: both;margin-top:20px ;"></div>
        <input class="btn btn-default" type="button" id="add_tax_rate" value="<?php _e('Add Tax Rate','wpdm-premium-package'); ?>">
     </div>
</div>
...
jQuery(function() {
    ...
    jQuery('#add_tax_rate').click(function() {
        ...
        jQuery('#intr_rate').append('<tr id="r_'+tmy+'">' +
            ...
            '<td><a href="#" class="del_rate" rel="'+tmy+'">Delete</a></td>' +
            '</tr>');
