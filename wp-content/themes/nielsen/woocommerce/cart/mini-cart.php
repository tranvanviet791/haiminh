...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward btn btn-ghost"><?php _e( 'View Cart', 'yit' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward btn btn-flat-red"><?php _e( 'Checkout', 'yit' ); ?></a>
    </p>
