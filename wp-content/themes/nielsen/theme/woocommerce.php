...
function yit_remove_add_to_cart_redirect( $url ) {
...
add_filter( yit_get_add_to_cart_redirect_filter_name(), 'yit_remove_add_to_cart_redirect' , 10 , 1 );
...
function yit_sidebar_shop_page( $value, $key, $id ) {
    ...
    if ( isset( $value['layout'] ) && $new_layout != '' && $key == 'sidebars' ) {
        ...
        if ( isset( $value['sidebar-left'] ) && $value['sidebar-left'] == - 1 ) {
            if( isset(  $value['sidebar-right'] ) ) {
                $value['sidebar-left'] = $value['sidebar-right'];
            }
        }
        elseif ( isset( $value['sidebar-right'] ) && $value['sidebar-right'] == - 1 ) {
            if( isset(  $value['sidebar-left'] ) )  {
